...
namespace PB.ItemCrafting
{
	...
	[ProtoContract(Name = "MysteryData")]
	[TypeConverter(typeof(ExpandableObjectConverter))]
	[Serializable]
	public class MysteryData : IExtensible
	{
		...
		[ProtoMember(1, Name = "extracted_mystery", DataFormat = DataFormat.FixedSize)]
		public List<int> extracted_mystery
		{
			get
			{
				return this._extracted_mystery;
			}
			set
			{
				this._extracted_mystery = value;
			}
		}
		...
		[DefaultValue(null)]
		public byte[] extracted_mystery_bitfield
		{
			get
			{
				return this._extracted_mystery_bitfield;
			}
			set
			{
				this._extracted_mystery_bitfield = value;
			}
		}
		...
		private List<int> _extracted_mystery = new List<int>();

		// Token: 0x0400018D RID: 397
		private byte[] _extracted_mystery_bitfield;
